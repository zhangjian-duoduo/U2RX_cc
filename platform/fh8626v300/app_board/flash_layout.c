...
struct _tag_flash_layout_info g_flash_layout_info[MAX_FLASH_PART_NUM] = {
    ...
    {"user-prog",   0x500000, BLOCK_64K, PART_NN_MODEL | PART_USER},
    /* another reserved partition */
    {"reservd3",    0x1D0000, BLOCK_64K, PART_RESERVED},
};
